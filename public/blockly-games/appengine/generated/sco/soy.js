...
BlocklyGames.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return '<div style="display: none"><span id="Games_name">Blockly Games</span><span id="Games_puzzle">Jigsaw puzzle</span><span id="Games_maze">Maze</span><span id="Games_bird">Bird</span><span id="Games_turtle">Turtle</span><span id="Games_movie">Movie</span><span id="Games_pondBasic">Pond</span><span id="Games_pondAdvanced">JS Pond</span><span id="Games_linesOfCode1">You solved this level with 1 line of JavaScript:</span><span id="Games_linesOfCode2">You solved this level with %1 lines of JavaScript:</span><span id="Games_nextLevel">Are you ready for level %1?</span><span id="Games_finalLevel">Are you ready for the next challenge?</span><span id="Games_linkTooltip">Hain n airt til blocks.</span><span id="Games_runTooltip">Run the program you wrote.</span><span id="Games_runProgram">Rin Program</span><span id="Games_resetTooltip">Stop the program and reset the level.</span><span id="Games_resetProgram">Reset</span><span id="Games_help">Heelp</span><span id="Games_dialogOk">OK</span><span id="Games_dialogCancel">Cancel</span><span id="Games_catLogic">Logeec</span><span id="Games_catLoops">Luips</span><span id="Games_catMath">Maths</span><span id="Games_catText">Tex</span><span id="Games_catLists">Leets</span><span id="Games_catColour">Colour</span><span id="Games_catVariables">Variables</span><span id="Games_catProcedures">Functions</span><span id="Games_httpRequestError">Thaur wis ae problem wi the request.</span><span id="Games_linkAlert">Shair yer blocks wi this airtin:\n\n%1</span><span id="Games_hashError">Sairrie, \'%1\' disna correspond wi onie hained program.</span><span id="Games_xmlError">Coudnae laid yer hained file.  Perhaps it wis makit wi ae deefferent version o Blockly?</span><span id="Games_listVariable">leet</span><span id="Games_textVariable">tex</span></div>';
};
