...
BlocklyGames.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return '<div style="display: none"><span id="Games_name">Blockly Games</span><span id="Games_puzzle">Puzzle</span><span id="Games_maze">Labirint</span><span id="Games_bird">Bird</span><span id="Games_turtle">Țestoasă</span><span id="Games_movie">Movie</span><span id="Games_pondBasic">Pond</span><span id="Games_pondAdvanced">JS Pond</span><span id="Games_linesOfCode1">You solved this level with 1 line of JavaScript:</span><span id="Games_linesOfCode2">You solved this level with %1 lines of JavaScript:</span><span id="Games_nextLevel">Are you ready for level %1?</span><span id="Games_finalLevel">Are you ready for the next challenge?</span><span id="Games_linkTooltip">Salvează și adaugă la blocuri. </span><span id="Games_runTooltip">Run the program you wrote.</span><span id="Games_runProgram">Rulează programul</span><span id="Games_resetTooltip">Stop the program and reset the level.</span><span id="Games_resetProgram">Resetează</span><span id="Games_help">Ajutor</span><span id="Games_dialogOk">OK</span><span id="Games_dialogCancel">Revocare</span><span id="Games_catLogic">Logic</span><span id="Games_catLoops">Bucle</span><span id="Games_catMath">Matematică</span><span id="Games_catText">Text</span><span id="Games_catLists">Liste</span><span id="Games_catColour">Culoare</span><span id="Games_catVariables">Variabile</span><span id="Games_catProcedures">Funcții</span><span id="Games_httpRequestError">A apărut o problemă la solicitare.</span><span id="Games_linkAlert">Distribuie-ți blocurile folosind această legătură:\n\n%1</span><span id="Games_hashError">Scuze, „%1” nu corespunde nici unui program salvat.</span><span id="Games_xmlError">Sistemul nu a putut încărca fișierul salvat. Poate că a fost creat cu o altă versiune de Blockly?</span><span id="Games_listVariable">listă</span><span id="Games_textVariable">text</span></div>';
};
...
BlocklyGames.soy.abortDialog = function(opt_data, opt_ignored, opt_ijData) {
  return '<div id="dialogAbort" class="dialogHiddenContent">This level is extremely difficult. Would you like to skip it and go onto the next game? You can always come back later.<div id="dialogAbortButtons" class="farSide" style="padding: 1ex 3ex 0"><button id="abortCancel">Revocare</button><button id="abortOk" class="secondary">OK</button></div></div>';
};
