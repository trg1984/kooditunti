...
BlocklyGames.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return '<div style="display: none"><span id="Games_name">Blockly Games</span><span id="Games_puzzle">Puzzle</span><span id="Games_maze">Labirent</span><span id="Games_bird">Bird</span><span id="Games_turtle">Kesey</span><span id="Games_movie">Movie</span><span id="Games_pondBasic">Pond</span><span id="Games_pondAdvanced">JS Pond</span><span id="Games_linesOfCode1">You solved this level with 1 line of JavaScript:</span><span id="Games_linesOfCode2">You solved this level with %1 lines of JavaScript:</span><span id="Games_nextLevel">Are you ready for level %1?</span><span id="Games_finalLevel">Are you ready for the next challenge?</span><span id="Games_linkTooltip">Qeyd ke û be blokan ra gıre de.</span><span id="Games_runTooltip">Run the program you wrote.</span><span id="Games_runProgram">Programi Akar fi</span><span id="Games_resetTooltip">Stop the program and reset the level.</span><span id="Games_resetProgram">Reset kerê</span><span id="Games_help">Peşti</span><span id="Games_dialogOk">TEMAM</span><span id="Games_dialogCancel">Bıtexelne</span><span id="Games_catLogic">Mantığ</span><span id="Games_catLoops">Dingeki</span><span id="Games_catMath">Matematik</span><span id="Games_catText">Metin</span><span id="Games_catLists">Listey</span><span id="Games_catColour">Reng</span><span id="Games_catVariables">Vırneyeni</span><span id="Games_catProcedures">Fonksiyoni</span><span id="Games_httpRequestError">waştışi deyne zew problem esto</span><span id="Games_linkAlert">Blokan na linkera bıhesrne\n\n%1</span><span id="Games_hashError">Melûlime, \'%1\' be qet yew programi ra yewbini nêgêno.</span><span id="Games_xmlError">Could not load your saved file. Perhaps it was created with a different version of Blockly?</span><span id="Games_listVariable">liste</span><span id="Games_textVariable">nuşte</span></div>';
};
...
BlocklyGames.soy.abortDialog = function(opt_data, opt_ignored, opt_ijData) {
  return '<div id="dialogAbort" class="dialogHiddenContent">This level is extremely difficult. Would you like to skip it and go onto the next game? You can always come back later.<div id="dialogAbortButtons" class="farSide" style="padding: 1ex 3ex 0"><button id="abortCancel">Bıtexelne</button><button id="abortOk" class="secondary">TEMAM</button></div></div>';
};
