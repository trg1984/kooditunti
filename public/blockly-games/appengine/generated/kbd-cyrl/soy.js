...
BlocklyGames.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return '<div style="display: none"><span id="Games_name">Blockly и джэгукIэхэр</span><span id="Games_puzzle">Узыгъэгупсысэ</span><span id="Games_maze">Дыхьэ-дэкI</span><span id="Games_bird">Бзу</span><span id="Games_turtle">Шылъэгу</span><span id="Games_movie">Нэтын</span><span id="Games_pondBasic">Псыхъурей</span><span id="Games_pondAdvanced">JS Pond</span><span id="Games_linesOfCode1">You solved this level with 1 line of JavaScript:</span><span id="Games_linesOfCode2">You solved this level with %1 lines of JavaScript:</span><span id="Games_nextLevel">Are you ready for level %1?</span><span id="Games_finalLevel">Are you ready for the next challenge?</span><span id="Games_linkTooltip">Хъумауэ блокхэм я техьэпIэр къэгъэлъагъуэн.</span><span id="Games_runTooltip">Run the program you wrote.</span><span id="Games_runProgram">Программэр егъэжьэн</span><span id="Games_resetTooltip">Программэр къэгъэувыIауэ здынэсари щыгъэгъупщэн.</span><span id="Games_resetProgram">Псори щыгъэгъупщэн</span><span id="Games_help">ДэӀэпыкъуэгъу</span><span id="Games_dialogOk">ХЪУАЩ</span><span id="Games_dialogCancel">ЩӀегъуэжын</span><span id="Games_catLogic">Logic</span><span id="Games_catLoops">Loops</span><span id="Games_catMath">Математикэ</span><span id="Games_catText">Тхыгъэ</span><span id="Games_catLists">КъебжэкI</span><span id="Games_catColour">Плъыфэ</span><span id="Games_catVariables">Variables</span><span id="Games_catProcedures">Functions</span><span id="Games_httpRequestError">There was a problem with the request.</span><span id="Games_linkAlert">Share your blocks with this link:\\n\\n%1</span><span id="Games_hashError">Sorry, \'%1\' doesn\'t correspond with any saved program.</span><span id="Games_xmlError">Could not load your saved file. Perhaps it was created with a different version of Blockly?</span><span id="Games_listVariable">къебжэкI</span><span id="Games_textVariable">text</span></div>';
};
...
BlocklyGames.soy.abortDialog = function(opt_data, opt_ignored, opt_ijData) {
  return '<div id="dialogAbort" class="dialogHiddenContent">This level is extremely difficult. Would you like to skip it and go onto the next game? You can always come back later.<div id="dialogAbortButtons" class="farSide" style="padding: 1ex 3ex 0"><button id="abortCancel">ЩӀегъуэжын</button><button id="abortOk" class="secondary">ХЪУАЩ</button></div></div>';
};
