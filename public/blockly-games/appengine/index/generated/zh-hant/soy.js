...
Index.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return '<div style="display: none"><span id="title">Blockly 遊戲</span><span id="Index_clear">Delete all your solutions?</span></div>';
};


Index.soy.start = function(opt_data, opt_ignored, opt_ijData) {
  return Index.soy.messages(null, null, opt_ijData) + '<div id="header"><img id="banner" src="index/title-beta.png" height="51" width="244" alt="Blockly Games"><div id="subtitle">Games for tomorrow\'s programmers. &nbsp;' + ((opt_ijData.html) ? '<a href="about.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">' : '<a href="about?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">') + 'More info...</a></div></div><svg height="100%" width="100%" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g transform="translate(-80,-60)"><svg height="100%" width="100%" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100" preserveAspectRatio="none" x=80 y=60><path id="path" d="M 10,15 C 15,60 35,100 50,70 S 80,20 90,85"/></svg>' + Index.soy.appLink({app: 'puzzle', x: 10, y: 15, contentText: '拼圖'}, null, opt_ijData) + Index.soy.appLink({app: 'maze', x: 16, y: 47, contentText: '迷宮'}, null, opt_ijData) + Index.soy.appLink({app: 'bird', x: 29, y: 75, contentText: '鳥'}, null, opt_ijData) + Index.soy.appLink({app: 'turtle', x: 49, y: 72, contentText: '烏龜'}, null, opt_ijData) + Index.soy.appLink({app: 'movie', x: 64, y: 48, contentText: 'Movie'}, null, opt_ijData) + Index.soy.appLink({app: 'pond-basic', x: 83, y: 53, contentText: 'Pond'}, null, opt_ijData) + Index.soy.appLink({app: 'pond-advanced', x: 90, y: 85, contentText: 'JS Pond'}, null, opt_ijData) + '</g></svg><select id="languageMenu"></select><p id="clearDataPara" style="visibility: hidden">Want to start over?<button class="secondary" id="clearData">清空資料</span></button></p>';
};
