...
Blockly.Trashcan.prototype.position_=function(){var a=this.workspace_.getMetrics();
  /* HACK: CHANGED TRASHCAN POSITION CALCULATIONS */
  a&&(this.left_=Blockly.RTL?this.MARGIN_SIDE_:this.MARGIN_SIDE_,this.top_=a.viewHeight+a.absoluteTop-(this.BODY_HEIGHT_+this.LID_HEIGHT_)-this.MARGIN_BOTTOM_,this.svgGroup_.setAttribute("transform","translate("+this.left_+","+this.top_+")"))};
...
Blockly.Block.prototype.onMouseUp_=function(a){var b=this;Blockly.doCommand(function(){Blockly.terminateDrag_();
/* UNMINIFIED START */
if (Blockly.selected && Blockly.highlightedConnection_) {
    ...
    if (b.workspace.trashcan && b.workspace.trashcan.isOpen) {
      // Don't throw an object in the trash can if it just got connected.
      b.workspace.trashcan.close();
    }
  /* HACK START */
    b.afterConnection(inferiorConnection);
  /* HACK END */
/* UNMINIFIED END */
} else if(b.workspace.trashcan&&b.workspace.trashcan.isOpen){var a=b.workspace.trashcan;goog.Timer.callOnce(a.close,100,a);Blockly.selected.dispose(!1,!0);Blockly.fireUiEvent(window,"resize")}Blockly.highlightedConnection_&&(Blockly.highlightedConnection_.unhighlight(),Blockly.highlightedConnection_=null)})
/* HACK START */
  this.afterMouseUp();
};
Blockly.Block.prototype.afterConnection = function(){ return null; }
Blockly.Block.prototype.afterMouseUp = function(){ return null; }
/* HACK END */
Blockly.Block.prototype.showHelp_=function(){var a=goog.isFunction(this.helpUrl)?this.helpUrl():this.helpUrl;a&&window.open(a)};
